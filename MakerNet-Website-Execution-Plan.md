...
**Subsystem 1 open gate:** Manual screen-reader verification could not run because this environment exposed neither a visible browser through Browser Use nor the Windows Computer Use native helper. Local Docker staging of this candidate, hosted CI, merge, and `v0.2.0` tagging remain pending. Keep Subsystem 2 closed until the Subsystem 1 gate is met.
