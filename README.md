...
MakerNet connects campus makers, skills, and practical guides. The repository is following [the website execution plan](MakerNet-Website-Execution-Plan.md) in subsystem order. Subsystem 0 is in progress; product workflows have not been implemented.
